...
def seed() -> None:
    ...
    try:
        ...
        specs = [
            ...
            ("IA1.AT.C.11", "Average Rate of Change", "Calculate or estimate and interpret the average rate of change of linear and exponential functions over a specified interval using graphs, tables, or symbolic representations.", 3, "MATH.IA1.AT.C.11"),
            ("IA1.AT.C.12", "Compare Linear and Exponential Functions", "Compare rates of change, intercepts, and growth patterns of a linear function and an exponential function when the functions are represented in different ways, including equations, graphs, tables, and contextual descriptions.", 3, "MATH.IA1.AT.C.12"),
            ("IA1.AT.D.13", "Arithmetic and Geometric Sequences", "Analyze arithmetic and geometric sequences using explicit and recursive representations, and model contextual patterns with sequence rules.", 3, "MATH.IA1.AT.D.13"),
            ("IA1.AT.D.14", "Function Representations and Features", "Represent functions with tables, graphs, equations, and contextual descriptions and interpret key features, including piecewise and absolute-value representations.", 3, "MATH.IA1.AT.D.14"),
        ...
        problems = [
            ...
            ("IA1.AT.C.11", "A linear function has values f(2) = 7 and f(6) = 19. What is its average rate of change from x = 2 to x = 6?", "3", 2),
            ("IA1.AT.C.12", "Function A is y = 4x + 3. Function B starts at 3 and doubles whenever x increases by 1. Which function has exponential growth?", "Function B", 2),
            ("IA1.AT.D.13", "A savings pattern begins 12, 17, 22, 27. Is the sequence arithmetic or geometric?", "Arithmetic", 2),
            ("IA1.AT.D.14", "A parking garage charges $4 for the first hour and $2 for each additional hour. Which type of function representation can use different rules on different time intervals?", "A piecewise function", 2),
