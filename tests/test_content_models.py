...
def test_content_tables_registered_with_metadata():
    ...
    assert ProblemContentMetadata.__tablename__ in Base.metadata.tables
...
def test_problem_metadata_carries_curriculum_and_learning_modes():
    table = Base.metadata.tables["problem_content_metadata"]
    for column in (
        "problem_id",
        "curriculum_id",
        "objective",
