...
BADGE_CATALOG: dict[str, BadgeSpec] = {
    ...
    for spec in (
        BadgeSpec(
            "FIRST_CORRECT",
            "First Steps",
            "Solved your first problem correctly",
            per_skill=False,
        ),
        BadgeSpec(
            "STREAK_3",
        ...
        BadgeSpec(
            "LEVEL_UP",
            "Level Up",
            "Difficulty increased on this skill",
            per_skill=True,
        ),
        BadgeSpec(
            "SKILL_MASTERED",
            "Skill Mastered",
            "Passed the independent mastery check",
            per_skill=True,
        ),
        BadgeSpec(
            "GAP_FIXED",
            "Gap Fixed",
            "Cleared a prerequisite gap and returned",
            per_skill=True,
        ),
        BadgeSpec(
            "FRESH_EYES",
            "Fresh Eyes",
            "Passed a spaced review",
            per_skill=True,
        ),
    )
}
